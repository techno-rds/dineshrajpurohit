...
var configs = (function() {
  ...
  Singleton.defaultOptions = {
    ...
    welcome:
      "Hello, I’m Dinesh Rajpurohit, a Software Enginner with over 6+ years experience. All I want to do is to make things, especially clean, user friendly & magical apps. Today I currently work at edeXa. Previously I’ve worked at ViitorCloud and Zealousweb. To get in touch and talk about fun projects, Please open the navigation drawer for more options or Type 'help' in shell :)",
    welcomenew:
    "Hello, I’m Dinesh Rajpurohit, a Software Enginner with over 6+ years experience. All I want to do is to make things, especially clean, user friendly & magical apps. Today I currently work at edeXa. Previously I’ve worked at ViitorCloud and Zealousweb. To get in touch and talk about fun projects.",
...
var files = (function() {
  ...
  Singleton.defaultOptions = {
    "about.txt":
      "I'm a Team Leader At Edexa. At the moment I'm a big fan of Hyperledger Fabric, Docker and Kubernetes",
    "contact.txt": "rajpurohitdinesh92@gmail.com",
    "StackOverFlow": "https://stackoverflow.com/users/5503275/dsraj",
    "LinkedIn.txt": "https://in.linkedin.com/in/dinesh-rajpurohit-9b450286",
    "GitHub.txt": "https://github.com/techno-rds",
    "CurriculumVitae": "https://dineshrajpurohit.tech/cv/"
  };
  return {
    getInstance: function(options) {
      instance === void 0 && (instance = new Singleton(options));
